...
<table>
  <tr>
    <td align="center">
      <a name="fig1"></a>
      <img src="https://github.com/SchrodingerJia/EMG_Control_System/tree/master/figures/臂环.png" width="300" alt="图 1 EMGRPO 8 通道肌电臂环"/><br/>
      <strong>图 1</strong> EMGRPO 8 通道肌电臂环
    </td>
    <td align="center">
      <a name="fig2"></a>
      <img src="https://github.com/SchrodingerJia/EMG_Control_System/tree/master/figures/穿戴位置.png" width="300" alt="图 2 EMGRP 电极片采样位置——肱骨桡关节的矢状面"/><br/>
...
<a name="fig3"></a>
![<strong>图 3</strong> 8 通道肌电波形图](https://github.com/SchrodingerJia/EMG_Control_System/tree/master/figures/肌电波形可视化.png)
...
<a name="fig4"></a>
![<strong>图 4</strong> 模型结构](https://github.com/SchrodingerJia/EMG_Control_System/tree/master/figures/模型结构.png)
...
<a name="fig5"></a>
![<strong>图 5</strong> 激活函数评分图](https://github.com/SchrodingerJia/EMG_Control_System/tree/master/figures/激活函数.png)
...
<a name="fig6"></a>
![<strong>图 6</strong> 17 种手势动作具体图片](https://github.com/SchrodingerJia/EMG_Control_System/tree/master/figures/17手势.png)
...
<a name="tab3"></a> 
<div align="center"><strong>表 3</strong> 手势与机械臂动作对应关系</div>

| 手势名称 | 手势展示 | 标签 | 机械臂动作 | 动作展示 |
|---------|----------|-----|-----------|----------|
| 左挥 | ![左挥](https://github.com/SchrodingerJia/EMG_Control_System/tree/master/figures/左挥.png) | a | 左转 | ![左转](https://github.com/SchrodingerJia/EMG_Control_System/tree/master/figures/左转.png) |
| 右挥 | ![右挥](https://github.com/SchrodingerJia/EMG_Control_System/tree/master/figures/右挥.png) | d | 右转 | ![右转](https://github.com/SchrodingerJia/EMG_Control_System/tree/master/figures/右转.png) |
| 压手 | ![压手](https://github.com/SchrodingerJia/EMG_Control_System/tree/master/figures/压手.png) | s | 垂臂 | ![垂臂](https://github.com/SchrodingerJia/EMG_Control_System/tree/master/figures/垂臂.png) |
| 抬手 | ![抬手](https://github.com/SchrodingerJia/EMG_Control_System/tree/master/figures/抬手.png) | w | 抬臂 | ![抬臂](https://github.com/SchrodingerJia/EMG_Control_System/tree/master/figures/抬臂.png) |
| 下指 | ![下指](https://github.com/SchrodingerJia/EMG_Control_System/tree/master/figures/下指.png) | e | 夹取 | ![夹取](https://github.com/SchrodingerJia/EMG_Control_System/tree/master/figures/夹取.png) |
| 上指 | ![上指](https://github.com/SchrodingerJia/EMG_Control_System/tree/master/figures/上指.png) | q | 释放 | ![释放](https://github.com/SchrodingerJia/EMG_Control_System/tree/master/figures/释放.png) |
| 其他 | | IDLE | 保持静止 | |
...
<a name="tab4"></a> 
<div align="center"><strong>表 4</strong> CNN 神经网络模型识别效果</div>
